...
int getword( char *w){
	...
	// when iochar hits a ~ character, the for loop will place each element of the array that has the home directory in it into iochar then into the buffer to get the correct output.
